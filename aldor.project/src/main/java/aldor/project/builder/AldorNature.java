...
public class AldorNature implements IProjectNature {

	/**
	 * ID of this project nature
	 */
	public static final String NATURE_ID = "aldor.project.aldorNature";
	...
	public void configure() throws CoreException {
		...
		for (int i = 0; i < commands.length; ++i) {
			if (commands[i].getBuilderName().equals(AldorBuilder.BUILDER_ID)) {
				return;
			}
		}

		ICommand command = desc.newCommand();
		command.setBuilderName(AldorBuilder.BUILDER_ID);
